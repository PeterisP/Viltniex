...
class Pages():
	def __init__(self, hc):
		...
		self.pages = [
			...
			Page('a_enemy',		'images/a_enemy.png',	(640, 430, 150, 50), confidence=0.9),
			Page('a_enemy2',	'images/a_enemy2.png',	(640, 430, 150, 50), confidence=0.9),
			...
			Page('a_combat',	'images/a_combat.png',	(450, 10,  100, 50), confidence=0.9),
